...
def train_CIFAR10(X_train_noise,X_test_noise,y_train_reshaped,y_test):
        ...
        return test_loss,test_acc,model_summary
...
def waldp_time(original_path, output_path, epsilon, pixel, L,cluster_num, test_env, seeds,label_epsilon,data):
    ...
    # ★ CNNからRandomForestへ変更
            test_loss, test_acc, current_summary = train_RF(
                X_train_noise, 
                X_test_noised, 
                y_train_noise, 
                y_test
...
if __name__ == "__main__":
    ...
    for P, L,cluster_num,test_env in params:
        for eps in epsilons:
            ...
            output_path = f"../../experiments/{data}/CWALDP/RF/RR_waldp_L{L}_PI{P}_C{cluster_num}_eps{eps}_env{test_env}_label_noise_{label_epsilon}_time.csv"
