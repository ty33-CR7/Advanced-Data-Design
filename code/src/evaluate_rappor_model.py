...
# --- 3) 全サンプルにノイズを適用 ---
    ...
    X_train, X_test, y_train, y_test= train_test_split(
        bf, y, test_size=0.2, random_state=seed, stratify=y
    )
...
if __name__ == "__main__":
    ...
    if DATASET_NAME == "FashionMNIST":
        ...
        #original_path = f"{BASE_DIR}/{DATASET_NAME}/Rappor/fmnist_rappor_bfonly_mFalse_k1496_h{HASH_NUMBER}.npz"
        original_path=f"{BASE_DIR}/{DATASET_NAME}/BF/imporve_fmnist_bf_cv10_fp0.4_n{neighbor}_NOISE0_k1_PI1.0_L{L}.npz"
    ...
    for eps in EPSILONS:
        ...
        output_image_path = f"../../experiments/{DATASET_NAME}/Rappor_Eval/eps{eps}_k{HASH_NUMBER}_noise{noise_p:.4f}_{timestamp}.png"
